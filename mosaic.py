...
def main() -> None:
    ...
    folders = [f"{time[:8]}/{site}" for time, site in zip(times, sites)]

    heights = np.array([ 500,  1000,  1500,  2000,  2500,  3000,  3500,
                        4000,  4500,  5000,  5500,  6000,  7000,  8000,
                        9000, 10000, 12000, 14000, 15500, 17000, 19000])
        ...
        data = concat(
            [
                GridMapper(
                    [
                        get_dataset(
                            filename=(filepath / folder / f"{time}.nc"),
                            height=height,
                        )
